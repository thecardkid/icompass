...
class LandingPage extends Component {
  ...
  promptForEmail = (text) => {
    this.modal.prompt(text || 'If you would like to email you a link to the compass, enter your email below. I will not store your email address or send you spam. Without the code or link, you will not be able to retrieve your workspace! Leave blank if you do not want this reminder email', (status, email) => {
      if (!status) return;
