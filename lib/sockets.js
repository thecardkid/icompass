...
let Compass = require('../models/compass');
    ...
    io.sockets.on('connection', function(client) {
      ...
      client.on('disconnect', function(reason) {
        if (client.username) {
          ...
          let m = Manager.removeUser(client.room, client.username);
      ...
      client.on('reconnected', function(data) {
        ...
        let o = Manager.addUser(client.room, client.username, data.color);
        io.sockets.in(client.room).emit('user joined', { users: o.manager, joined: client.username });
      });
