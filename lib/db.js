...
switch (env) {
    case 'production':
        ...
        auth = uname + ':' + password;
        db = mongoose.connect('mongodb://' + auth + '@ds145603-a0.mlab.com:45603,ds145603-a1.mlab.com:45603/icompass-production?replicaSet=rs-ds145603', options);
    ...
    case 'test':
        ...
        if (!password) logger.error('No password provided for mongodb connection');
        auth = uname + ':' + password;
        db = mongoose.connect('mongodb://' + auth + '@ds127443.mlab.com:27443/staging', options);
