...
const PROMPTS = {
  ...
  COMPASS_NOT_FOUND: '<h3>Workspace not found</h3><p>Please check the code you provided. The permissions (edit/view) and the code might not match.</p><p>You will now be directed to the login page</p>',
...
module.exports.HOST = process.env.HOST || 'http://localhost:8080';
