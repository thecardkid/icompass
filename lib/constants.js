...
const PROMPTS = {
    ...
    POST_IT_TOO_LONG: 'You can\'t fit that much on a sticky note!',
    ...
    CONFIRM_DELETE_BOOKMARK: 'Delete this workspace bookmark?',
    ...
    PROMPT_NAME: 'Welcome to Innovators\' Compass. Please enter your name as it would appear to others in this workspace:'
};
...
module.exports.MODALS = {
    ...
    SAVE_BOOKMARK: 'What name should this workspace be saved as?',
...
module.exports.QUADRANTS_INFO = [
    ...
    {id: 'ideas', prompt: 'What ways are there?'},
    {id: 'experiments', prompt: 'What\'s a step to try?'}
];
